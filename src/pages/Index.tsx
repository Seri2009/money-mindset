...
const Index = () => {
  ...
  const allRecentArticles = getRecentArticles(50); // Get more articles initially
  const { displayItems: recentArticles, hasMore } = useInfiniteScroll(allRecentArticles, 9, 6);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-6">
              {allRecentArticles.slice(0, 3).map((article) => (
